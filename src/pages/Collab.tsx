        ...
        <div className="min-h-screen pb-24">
            ...
            <div className="bg-brand-dark text-white pt-32 pb-20 px-6 rounded-b-[5rem] text-center mb-20 overflow-hidden relative">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold font-serif mb-8 leading-tight">Elevate Your Brand <br/> with <span className="text-primary italic">Kaju's Kitchen</span></h1>
